 ...
 * @version 2025-07-17
 */
public class FindKHeapNTimingExperiment extends TimingExperiment {
    ...
    public static void main(String[] args) {
        TimingExperiment timingExperiment = new FindKHeapNTimingExperiment();
        timingExperiment.printResults();
    }

    public FindKHeapNTimingExperiment() {
        super(
    ...
    protected void setupExperiment(int problemSize) {
        chosenK = Math.max(1, problemSize-10);
    ...
    protected void runComputation() {
        FindKLargest.findKLargestHeap(toAdd, chosenK);
    }
}
