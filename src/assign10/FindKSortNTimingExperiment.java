 ...
 * @version 2025-07-17
 */
public class FindKSortNTimingExperiment extends TimingExperiment {
    ...
    public static void main(String[] args) {
        TimingExperiment timingExperiment = new FindKSortNTimingExperiment();
        timingExperiment.printResults();
    }

    public FindKSortNTimingExperiment() {
        super(
